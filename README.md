# How to use Doxygen
Instead of simply using doxygen from a GUI or through a CMake package, its important to understand how the
underlying doxygen executable actually works. This repo includes:
  - `config.doxygen` : Template for Main Doxygen configuration which is passed to the executable.
  - `layout.doxygen` : Template for a Doxygen layout configuration file, optionally passed to the executable.

### Usage info printed from "doxygen --help":
